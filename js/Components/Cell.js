...
class Cell extends PureComponent{
    ...
    render(){
        ...
        return (
            ...
            <TouchableOpacity style={styles.container} onPress={()=>this.props.setModalVisible(true,info)}>
            {/* <Image source={{ uri: info.imageUrl }} style={styles.icon} /> */}
            <Image source={require("../img/1A0i13000000ufm1z1D11_R_640_10000_Q90.jpg") } style={styles.icon}/>
