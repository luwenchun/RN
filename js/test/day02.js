      ...
      render(){
        ...
        const slides = this.state.weather.map((elem, index) => {
            ...
            const hourView = elem.hours.map((hourElem, hourIndex) => {
              ...
              return (
                <View key={elem.key}>
                  <Image style={[styles.image,{}]} blurRadius={100}  source={elem.bg}></Image>
                  <ScrollView style={styles.pageContainer}  showsVerticalScrollIndicator={true}>
        ...
        return(
            <>
                ...
                <TouchableHighlight onPress={()=>this._back()} style={styles.backBtn}>
                      <Icon size={17} name="ios-list-back" style={[styles.backBtnIcon,{backgroundColor:'red'}]}></Icon>
                </TouchableHighlight>
            </>
        )
      }
